    ...
    return (
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Veiculos</h1>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Gerencie seus veiculos</p>
          </div>
        </div>
    ...
    return (
      <div>
        ...
        <EmptyState
          ...
          description="Cadastre seu primeiro veiculo para comecar"
          icon={
