...
export const vehicleSchema = z.object({
  brand: z.string().min(1, "Marca e obrigatoria").max(100),
  model: z.string().min(1, "Modelo e obrigatorio").max(100),
  year: z.coerce.number().int().min(1900, "Ano invalido").max(currentYear + 1, "Ano invalido"),
